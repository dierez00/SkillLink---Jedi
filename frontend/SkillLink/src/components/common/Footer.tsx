...
const Footer = () => {
  return (
    <footer className="w-full bg-black/80 border-t border-gray-300">
      <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              <div className="bg-black p-2 rounded-lg mr-3">
                <img src={lightning} alt="Un rayo" className={cn("w-[20px]")} />
              </div>
            ...
            <nav className="space-y-2 ">
              {[
                ...
                <Link
                  key={item.name}
                  to={item.href}
                  className="text-gray-400 hover:text-gray-200 text-sm transition-colors block"
                >
                  {item.name}
                </Link>
              ))}
          ...
          <div className="space-y-3">
            ...
            <form className="flex flex-wrap gap-1 space-x-2">
              <input
                type="email"
        ...
        <div className="mt-12 pt-8 border-t border-gray-300 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © 2025 Skill. Todos los derechos reservados.
          </p>
