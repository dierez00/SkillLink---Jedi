    ...
    <div className="relative flex min-h-screen flex-col bg-white">
        ...
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-4 text-[#121416]">
            <div className="size-4">
              <svg viewBox="0 0 48 48" fill="none" className="w-6 h-6 text-[#121416]">
          ...
          <nav className="flex items-center gap-9">
            <Link to="/" className="text-[#121416] text-sm font-medium">Home</Link>
            <Link to="/my-learning" className="text-[#121416] text-sm font-medium">My Courses</Link>
            <Link to="/browse" className="text-[#121416] text-sm font-medium">Browse</Link>
          </nav>
        </div>
      ...
      <div className="flex flex-1 gap-1 px-6 py-5 justify-center">
        ...
        <aside className="flex flex-col w-80">
          <h2 className="text-[#121416] text-[22px] font-bold px-4 pb-3 pt-5">Course Outline</h2>
          {lessons.map((lesson, idx) => (
            ...
            >
              <div className="flex flex-col justify-center">
                <p className="text-[#121416] text-base font-medium">{lesson.title}</p>
                <p className="text-[#6a7581] text-sm">{lesson.desc}</p>
              </div>
              {idx < Number(lessonId) ? (
                <span className="text-green-500">
                  <svg width="24" height="24" fill="currentColor"><path d="M229.66,77.66l-128,128a8,8,0,0,1-11.32,0l-56-56a8,8,0,0,1,11.32-11.32L96,188.69,218.34,66.34a8,8,0,0,1,11.32,11.32Z"/></svg>
                </span>
              ) : null}
            </div>
          ))}
        ...
        <main className="flex flex-col flex-1 max-w-[960px]">
          ...
          <div className="flex flex-wrap gap-2 p-4">
            <Link to="/my-learning" className="text-[#6a7581] text-base font-medium">My Courses</Link>
            <span className="text-[#6a7581] text-base font-medium">/</span>
            <span className="text-[#6a7581] text-base font-medium">Course {courseId}</span>
            <span className="text-[#6a7581] text-base font-medium">/</span>
            <span className="text-[#121416] text-base font-medium">{currentLesson.title}</span>
          </div>

          {/* Título de la lección */}
          <h2 className="text-[#121416] text-[28px] font-bold px-4 pb-3 pt-5">{currentLesson.title}</h2>
          ...
          <div className="p-4">
            ...
            >
              <button className="flex items-center justify-center rounded-full size-16 bg-black/40 text-white">
          ...
          <h3 className="text-[#121416] text-lg font-bold px-4 pb-2 pt-4">Lesson Summary</h3>
          <p className="text-[#121416] text-base font-normal pb-3 pt-1 px-4">
            This introductory lesson will guide you through the initial setup and basic concepts of programming. You'll learn about the tools and environments used by developers,
            and gain a foundational understanding of how programs work. By the end of this lesson, you'll be ready to write your first simple program.
          </p>

          {/* Conceptos clave */}
          <h3 className="text-[#121416] text-lg font-bold px-4 pb-2 pt-4">Key Concepts</h3>
          <div className="px-4">
